...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--extra-ldflags=-L/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.2.sdk/usr/lib/system --disable-bzlib --disable-doc --enable-cross-compile --arch=arm --target-os=darwin --cc=/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --as='gas-preprocessor/gas-preprocessor.pl /Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc' --sysroot=/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.2.sdk --cpu=cortex-a8 --extra-cflags='-arch armv7' --extra-ldflags='-arch armv7' --enable-pic --disable-zlib --disable-bzlib --enable-decoder=h264 --enable-demuxer=h264 --enable-parser=h264
prefix=/usr/local
...
SRC_PATH="/Users/michelleC/svn1/rtt/projects/movietest/ffmpeg/ffmpeg"
SRC_PATH_BARE=/Users/michelleC/svn1/rtt/projects/movietest/ffmpeg/ffmpeg
CC_IDENT=gcc 4.2.1 (GCC) (Apple Inc. build 5664) (dot 2)
ARCH=arm
CC=/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc
AS=gas-preprocessor.pl /Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc
LD=/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc
DEPCC=/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc
YASM=yasm
YASMDEP=yasm
AR=ar
RANLIB=ranlib
...
LN_S=ln -sf
STRIP=strip -x
CPPFLAGS= --sysroot=/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.2.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
...
CC_O=-o $@
LDFLAGS= -L/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.2.sdk/usr/lib/system -arch armv7 --sysroot=/Developer-3.2.5/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.2.sdk -Wl,-dynamic,-search_paths_first
